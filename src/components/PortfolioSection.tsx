    ...
    <section className="py-20 px-4" id="portfolio">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">Explore our latest work and creative solutions</p>
        </motion.div>
        ...
        {hasMoreItems && (
          ...
          >
            <Link
              to="/portfolio"
              className="inline-flex items-center px-8 py-3 bg-primary-600 text-white rounded-full hover:bg-primary-700 transition-colors"
            >
              See More Work
