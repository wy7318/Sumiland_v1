...
export function QuoteForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            let quoteId = id;
            const { custom_fields, ...quoteData } = formData;
            ...
            if (id) {
                ...
                const { error: updateError } = await supabase
                    ...
                    .eq('quote_id', id)
                    .eq('organization_id', quoteData.organization_id);
