    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-md mx-auto text-center">
          ...
          <p className="text-gray-600">You need to be part of an organization to manage accounts.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button
                type="button"
                onClick={() => navigate('/admin/vendors')}
                className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-xl text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition-colors"
              >
                <X className="w-4 h-4 mr-2" />
                Cancel
              </button>
              <button
                ...
                form="vendor-form"
                disabled={loading}
                className="inline-flex items-center px-6 py-2 text-sm font-medium rounded-xl text-white bg-rose-600 hover:bg-rose-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
              >
                <Save className="w-4 h-4 mr-2" />
                {loading ? 'Saving...' : 'Save Account'}
              </button>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} id="vendor-form" className="space-y-8">
          {/* Error Message */}
          <AnimatePresence>
            {error && (
              <motion.div
            ...
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Essential account details and identification</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={(e) => setFormData(prev => ({ ...prev, name: e.target.value }))}
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none text-lg"
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      value={formData.type}
                      onChange={(e) => setFormData(prev => ({ ...prev, type: e.target.value }))}
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none appearance-none bg-white"
                      required
                    >
            ...
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Primary contact and owner details</p>
                </div>
              </div>
            </div>
                ...
                {selectedCustomer ? (
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none"
                    />
                    ...
                    <AnimatePresence>
                      {showCustomerDropdown && customerSearch && (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -10 }}
                            className="absolute z-50 w-full mt-2 bg-white rounded-xl shadow-lg border border-gray-200 max-h-60 overflow-auto"
                        >
                          {filteredCustomers.length > 0 ? (
                            <ul className="py-2">
                              {filteredCustomers.map(customer => (
            ...
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Financial and operational information</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6 overflow-visible">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.payment_terms}
                  onChange={(e) => setFormData(prev => ({ ...prev, payment_terms: e.target.value }))}
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none"
                ...
                {selectedParentVendor ? (
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="font-medium text-gray-900">{selectedParentVendor.name}</div>
                    </div>
                    <button
                      type="button"
                      onClick={() => {
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Shipping and billing addresses</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className={cn("space-y-4 transition-opacity", formData.use_shipping_for_billing && "opacity-50")}>
                  <input
                    id="billing-address-line1"
                    type="text"
                    value={formData.billing_address_line1}
                    ...
                    disabled={formData.use_shipping_for_billing}
                    placeholder="Street address"
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none disabled:bg-gray-50 disabled:cursor-not-allowed"
                  />
                  <input
                    type="text"
                    value={formData.billing_address_line2}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Additional information and comments</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none resize-none"
              />
            </div>
          </div>
            ...
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Organization-specific information</p>
                </div>
              </div>
            </div>
