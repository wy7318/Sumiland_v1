                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex space-x-3">
                            <button
                                type="submit"
                                disabled={loading}
                                className="inline-flex items-center px-5 py-2.5 text-sm font-medium rounded-full text-white bg-primary-600 hover:bg-primary-700 transition-colors shadow-sm disabled:opacity-50"
                            >
                                            ...
                                            {formData.po_number && (
                                                <div className="inline-flex items-center text-sm text-gray-600">
                                                    ...
                                                    <input
                                                        ...
                                                        className="inline border-b border-dashed border-gray-300 focus:border-primary-500 focus:outline-none"
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div
                                                            ...
                                                            className={`text-sm font-medium mt-2 px-3 py-1 rounded-full transition-colors cursor-pointer ${isActive ? 'text-blue-700' : 'text-gray-500 hover:text-gray-700'
                                                                }`}
                                                        >
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                                        ...
                                                        <tr key={index}>
                                                            <td className="px-6 py-4">
                                                                <div>
                                                                    <input
                                                                        ...
                                                                        className="font-medium text-gray-900 w-full px-2 py-1 rounded border border-gray-300 focus:border-primary-500 focus:ring-1 focus:ring-primary-200 outline-none"
                                                                        required
                                                                    />
                                                                    <input
                                                                        type="text"
                                                                        ...
                                                                        className="text-sm text-gray-500 w-full mt-1 px-2 py-1 rounded border border-gray-300 focus:border-primary-500 focus:ring-1 focus:ring-primary-200 outline-none"
                                                                    />
                                                                </div>
                                                            </td>
                                                            <td className="px-6 py-4 text-right whitespace-nowrap">
                                                                <input
                                                                    ...
                                                                    className="text-sm text-gray-900 w-20 px-2 py-1 rounded border border-gray-300 focus:border-primary-500 focus:ring-1 focus:ring-primary-200 outline-none text-right"
                                                                    required
                                                                />
                                                            </td>
                                                            <td className="px-6 py-4 text-right whitespace-nowrap">
                                                                <input
                                                                    ...
                                                                    className="text-sm text-gray-900 w-24 px-2 py-1 rounded border border-gray-300 focus:border-primary-500 focus:ring-1 focus:ring-primary-200 outline-none text-right"
                                                                    required
                                                                />
                                                            </td>
                                                            <td className="px-6 py-4 text-right whitespace-nowrap">
                                        ...
                                        <button
                                            ...
                                            className="mt-4 w-full px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-primary-500 hover:text-primary-500 transition-colors flex items-center justify-center"
                                        >
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex justify-between items-center py-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-32 px-3 py-1 text-right rounded-lg border border-gray-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none font-medium text-green-600"
                                                />
                                            </div>
