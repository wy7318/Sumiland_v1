/*
  # Add weight tracking to purchase orders

  1. Changes
    - Add weight fields to purchase_order_items table
    - Add weight validation trigger
    - Update PO status change handler to track weights

  2. New Fields
    - unit_weight: Weight per unit
    - weight_unit: Unit of measurement (kg, g, lb, oz)
    - total_weight: Calculated total weight

  3. Validation
    - Ensure non-negative weights
    - Validate weight units match product settings
    - Auto-calculate total weights
*/

-- Add weight tracking fields to purchase_order_items
