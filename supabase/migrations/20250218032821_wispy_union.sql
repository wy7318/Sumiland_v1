...
BEGIN
  ...
  IF NEW.status = 'received' AND OLD.status != 'received' THEN
    ...
    SELECT 
      ...
      'purchase_received',
      CASE 
        -- For weight-based products, use total_weight as quantity
...
the total_weight is used for both the quantity and weight fields to ensure proper stock tracking.
For quantity-based products, uses quantity for tracking while weight remains NULL.';